...
- providing the one operational database URL used by ingestion, imports, migrations, and trusted Chat
  projection, with its environment variable name and Vercel Local/Preview/Production scope;
...
Whether the Neon project is new or existing is not a product decision. Generated SQL uses disposable
in-memory PGlite and requires no second Neon role, credential, or connection, as established by
