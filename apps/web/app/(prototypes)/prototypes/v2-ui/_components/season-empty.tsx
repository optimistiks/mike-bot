...
import { seasonLabel, type PrototypeSeason } from "../_lib/seasons";
 ...
 */
export function SeasonEmpty({ season }: { season: PrototypeSeason }) {
  return (
    <Empty className="arcade-empty">
      <EmptyHeader>
        ...
        <EmptyDescription className="arcade-text-xs leading-loose">
          {seasonLabel(season)} — в этом сезоне ничего не происходило.
        </EmptyDescription>
      </EmptyHeader>
    </Empty>
  );
