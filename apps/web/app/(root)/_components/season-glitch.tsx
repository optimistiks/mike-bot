 ...
 * production data is too, so a pattern that only accepts digits matches no
 * real Leaderboard URL at all.
 */
const LEADERBOARD_PATH = /^\/chats\/-?\d+\/leaderboards\//;
 ...
 * lives in the root layout, which does survive, and the URL is the one
